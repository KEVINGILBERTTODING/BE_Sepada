...
<head>
		...
		<!-- Favicon berguna untuk menambahkan logo pada title nama website -->
		
		<link rel="icon" type="image/png" href="<?= base_url('front-end/'); ?>assets/img/logo-sepada.png">
		<!-- Title -->
		<title>Sepada - Sistem pendaftaran tamu dan agenda</title>
